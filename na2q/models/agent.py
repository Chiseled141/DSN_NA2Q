...
class NA2QAgent:
    ...
    def __init__(
        ...
        q_params = list(self.model.agent_q_network.parameters()) + \
                   list(self.model.mixer.parameters())
    ...
    def select_actions_batch(
        ...
        Same as select_actions but for multiple parallel environments.
